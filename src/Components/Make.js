                ...
                <div className='w-1/4 h-3/4 bg-white'>
                    ...
                    <form>
                        ...
                        <div className='w-[90%] h-24 mx-auto my-10 relative'>
                            ...
                            <input name='password' ref={(e) => (input.current[2] = e)} onChange={handleUserPassword} className='w-full h-[50%] focus:outline-none border-b-2 border-black'></input>
                        </div>
                        <div className='w-[90%] h-24 mx-auto my-10 relative'>
                            <p className='text-slate-500 absolute top-3 left-1'>비밀번호 확인</p>
                            <input className='w-full h-[50%] bg-slate-300'></input>
                        </div>
                    </form>
